const char NAME_LIST[][11] = {
   "Jose", "Maria", "Joao", "Ana", "Antonio", "Augusto", "Francisca", "Francisco", "Antonia", "Carlos", "Adriana", "Paulo", "Juliana", "Pedro",
   "Marcia", "Lucas", "Fernanda", "Luiz", "Patricia", "Marcos", "Aline", "Luis", "Sandra", "Gabriel", "Camila", "Rafael", "Amanda", "Daniel",
   "Bruna", "Marcelo", "Jessica", "Bruno", "Leticia", "Eduardo", "Julia", "Felipe", "Luciana", "Raimundo", "Vanessa", "Rodrigo", "Mariana",
   "Manoel", "Gabriela", "Mateus", "Vera", "Otavio", "Andre", "Vitoria", "Alan", "Fernando", "Larissa", "Fabio", "Claudia", "Leonardo", "Beatriz",
...
const char SURNAME_LIST[][11] = {
   "Almeida", "Alves", "Andrade", "Barbosa", "Barros", "Batista", "Borges", "Braga", "Campos", "Calazans", "Cardoso", "Carvalho", "Castro",
   "Costa", "Dias", "Duarte", "Freitas", "Fernandes", "Ferreira", "Garcia", "Gomes", "Goncalves", "Lima", "Lopes", "Machado", "Marques",
   "Martins", "Medeiros", "Melo", "Mendes", "Miranda", "Monteiro", "Moraes", "Moreira", "Moura", "Nascimento", "Nunes", "Oliveira", "Pereira",
   "Ramos", "Reis", "Ribeiro", "Rocha", "Santana", "Santos", "Silva", "Soares", "Souza", "Teixeira", "Vieira"
};
